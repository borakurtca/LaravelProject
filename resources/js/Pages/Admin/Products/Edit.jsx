        ...
        <AdminLayout title="Ürün Düzenle">
            ...
            <div className="max-w-2xl">
                ...
                <form onSubmit={submit} className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm space-y-4">
                    ...
                    <div>
                        <InputLabel value="Mevcut Görsel" />
                        {product.image ? (
                            <img src={`/storage/${product.image}`} alt={product.name}
                                className="mt-1 h-24 w-24 rounded-xl object-cover border border-stone-200" />
                        ) : (
                            <div className="mt-1 flex h-24 w-24 items-center justify-center rounded-xl bg-stone-100">
                    ...
                    <div>
                        <InputLabel htmlFor="image" value="Yeni Görsel Yükle (opsiyonel)" />
                    ...
                    <PrimaryButton disabled={processing}>Değişiklikleri Kaydet</PrimaryButton>
                </form>
            </div>
        </AdminLayout>
    );
